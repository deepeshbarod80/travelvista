      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
          ...
          <div className="col-span-1 md:col-span-2">
            <Link to="/" className="mb-4 flex items-center gap-2 text-2xl font-bold">
            ...
            <p className="mb-6 max-w-md text-gray-300">
              Discover the world through our curated collection of travel stories. From hidden gems
              to iconic destinations, let your wanderlust guide your next adventure.
            </p>
        ...
        <div className="mt-8 flex flex-col items-center justify-between border-t border-gray-800 pt-8 md:flex-row">
          <p className="text-sm text-gray-400">© 2024 Travelvista. All rights reserved.</p>
